...
const fetchKioskList = async () => {
  try {
    const response = await axios.get('http://localhost:8080/api/devices/kiosks');
...
const fetchLectureRooms = async () => {
  try {
    const response = await axios.get('http://localhost:8080/api/lecturerooms');
...
const fetchEntryDevices = async () => {
  try {
    const response = await axios.get('http://localhost:8080/api/devices/entryDevices');
...
const addEntryDevice = () => {
  ...
  axios.post('http://localhost:8080/api/devices/entryDevices', payload).then((response) => {
